...
void moveDino(int jump = 0) {
	...
	gotoxy(dinoPos, 16 - dinoY); cout << "			UUUUUUUU";
	gotoxy(dinoPos, 17 - dinoY); cout << "			UUUUU UU";
	gotoxy(dinoPos, 18 - dinoY); cout << "			UUUUUUUU";
	gotoxy(dinoPos, 19 - dinoY); cout << " U	   UUUUUUUU ";
	gotoxy(dinoPos, 20 - dinoY); cout << " UUU   UUUUUUUUUU ";
	gotoxy(dinoPos, 21 - dinoY); cout << " BUUUUUUUUUUUU  B ";
	gotoxy(dinoPos, 22 - dinoY); cout << "   UUUUUUUUUUU    ";
